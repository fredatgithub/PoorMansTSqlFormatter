...
namespace PoorMansTSqlFormatterDemo
{
  public partial class MainForm : Form
  {
    ...
    private void SaveFormatSettings()
    {
      ...
      {
        Properties.Settings.Default.Formatter = FORMATTER_STANDARD;
      }
      ...
      if (radio_Formatting_Identity.Checked)
      {
        Properties.Settings.Default.Formatter = FORMATTER_IDENTITY;
      }

      Properties.Settings.Default.IdentityColoring = chk_IdentityColoring.Checked;

      if (radio_Formatting_Obfuscate.Checked)
      {
        Properties.Settings.Default.Formatter = FORMATTER_OBFUSCATE;
      }
